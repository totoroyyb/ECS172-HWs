...
# Test Model Accuracy
mt = replicMeans(100,"qeLin(ml100kpluscovs[,c('rating', 'userMean_perGenre', 'itemMean_perTypeofUser')], 'rating')$testAcc")
mb = replicMeans(1, "qeLin(ml100kpluscovs[,c('rating', 'userMean_perGenre', 'itemMean_perTypeofUser')], 'rating')$baseAcc")
cat("Test Accuracy:", mt, '\n')
cat("Base Accuracy:", mb, '\n')