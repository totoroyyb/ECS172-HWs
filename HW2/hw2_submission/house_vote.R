...
# Test Model Accuracy
ht = replicMeans(100, "qeLogit(house_vote_remove[,c('bill_id','bill_rating', 'voter_yespercent')], 'bill_rating')$testAcc")
hb = replicMeans(100, "qeLogit(house_vote_remove[,c('bill_id','bill_rating', 'voter_yespercent')], 'bill_rating')$baseAcc")
cat("Test Accuracy:", ht, '\n')
cat("Base Accuracy:", hb, '\n')
