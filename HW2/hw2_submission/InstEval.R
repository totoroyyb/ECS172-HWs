...
# Test Model Accuracy
it = replicMeans(100, "qeLin(InstEval[,c('y', 's_lectage', 'd_studage', 's_dept', 's_dept_service')], 'y')$testAcc")
ib = replicMeans(100, "qeLin(InstEval[,c('y', 's_lectage', 'd_studage', 's_dept', 's_dept_service')], 'y')$baseAcc")
cat("Test Accuracy:", it, '\n')
cat("Base Accuracy:", ib, '\n')